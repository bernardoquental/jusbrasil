...
### Só o símbolo (chevron tricolor)

Para ícones pequenos, favicons ou contextos onde o texto já está presente:

```tsx
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 51" fill="none" height="32" aria-hidden="true">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M4.761 48.76C.826 46.495-.523 41.48 1.75 37.56L20.951 4.422C23.223.5 28.256-.843 32.192 1.42c3.936 2.265 5.285 7.28 3.012 11.201L16.003 45.758C13.73 49.68 8.697 51.023 4.76 48.76" fill="#FFCE00"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M51.393 48.76c-3.936 2.263-8.968.92-11.241-3.002L20.95 12.622c-2.273-3.921-.924-8.936 3.011-11.2 3.937-2.265 8.97-.921 11.242 3L54.405 37.56c2.273 3.92.925 8.936-3.012 11.2Z" fill="#378CC8"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M34.867 3.894c-.054-.08-.105-.16-.162-.237-.099-.134-.205-.26-.31-.386-.071-.085-.138-.172-.213-.254-.093-.103-.193-.198-.29-.295-.097-.097-.192-.195-.295-.288-.083-.075-.171-.142-.257-.214-.126-.104-.25-.21-.385-.307-.077-.057-.16-.108-.24-.163a8.356 8.356 0 0 0-.448-.289c-.09-.052-.183-.1-.275-.15a7.897 7.897 0 0 0-.436-.222c-.117-.055-.236-.103-.355-.152a7.99 7.99 0 0 0-.372-.145 8.94 8.94 0 0 0-1.21-.325 7.964 7.964 0 0 0-.773-.109A7.674 7.674 0 0 0 27.67.331c-.12.006-.238.016-.358.027-.15.014-.3.03-.45.053a8.566 8.566 0 0 0-.783.156 9.436 9.436 0 0 0-.75.225 8.333 8.333 0 0 0-.373.145c-.119.05-.237.097-.354.152a8.172 8.172 0 0 0-.437.223c-.091.05-.184.097-.274.149a8.54 8.54 0 0 0-.45.29c-.08.054-.16.105-.238.162-.134.098-.26.203-.386.308-.086.07-.173.139-.256.213-.103.093-.198.191-.295.288-.098.098-.198.192-.29.295-.075.082-.142.169-.213.254-.106.126-.212.252-.31.386-.057.077-.108.157-.162.237-.1.146-.2.294-.292.448a8.165 8.165 0 0 0-.046 8.272l7.126 12.299 7.127-12.299a8.167 8.167 0 0 0-.047-8.271 8.63 8.63 0 0 0-.292-.45" fill="#7AB441"/>
</svg>
...
## Logo Jus IA (marca completa)

Uso: botão de acesso ao Jus IA no header (authenticated), seções de feature do produto.
- Altura recomendada: `h-[22px]` no header, `h-6` em botões

```tsx
// Botão "Jus IA" no header (autenticado) — símbolo + texto
// IMPORTANTE: use o símbolo (viewBox 30x32), não o wordmark completo.
// O wordmark (viewBox 115x32) já contém "Jus IA" em texto — combiná-lo com
// texto externo duplica o nome visualmente.
<a href="/jus-ia" className="inline-flex items-center gap-2 bg-primary text-primary-foreground font-semibold text-sm rounded-full px-4 h-9 cursor-pointer hover:bg-primary/90 transition-colors">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 32" fill="none" height="18" aria-hidden="true">
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#FC0" d="M26.098 0H12.663c-.508 0-.944.374-1.032.883l-.36 2.09s-.004.016-.004.023L8.768 17.52h5.734c.39 0 .746.216.93.565l6.428 12.342s.077.152.102.272c.016.079.023.134.028.178v.162a1 1 0 0 1-.014.1q.006-.02.01-.04l4.788-27.732.366-2.112A1.067 1.067 0 0 0 26.098 0"/>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#3D82DA" d="M6.478 31.181v-.004q-.007-.044-.011-.093v-.016c0-.027-.005-.057-.005-.085v-.03q0-.036.003-.074.001-.026.006-.053.002-.027.007-.055.01-.055.02-.113L8.767 17.52H1.049c-.792.002-1.298.862-.924 1.573l6.428 12.342.01.016a1 1 0 0 1-.085-.27"/>
    <path fill-rule="evenodd" clip-rule="evenodd" fill="#77B340" d="M21.99 31.038c-.041.584-.58.969-1.026.962H7.536c-.175 0-.356-.046-.356-.046-.557-.152-.82-.676-.681-1.296L8.766 17.52H14.5c.39 0 .747.216.931.565l6.428 12.342s.077.152.102.272.03.19.03.24z"/>
  </svg>
  Jus IA
</a>
```

### Só o símbolo Jus IA (para ícones / avatars)

```tsx
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 32" fill="none" height="22" aria-hidden="true">
  <path fill-rule="evenodd" clip-rule="evenodd" fill="#FC0" d="M26.098 0H12.663c-.508 0-.944.374-1.032.883l-.36 2.09s-.004.016-.004.023L8.768 17.52h5.734c.39 0 .746.216.93.565l6.428 12.342s.077.152.102.272c.016.079.023.134.028.178v.162a1 1 0 0 1-.014.1q.006-.02.01-.04l4.788-27.732.366-2.112A1.067 1.067 0 0 0 26.098 0"/>
  <path fill-rule="evenodd" clip-rule="evenodd" fill="#3D82DA" d="M6.478 31.181v-.004q-.007-.044-.011-.093v-.016c0-.027-.005-.057-.005-.085v-.03q0-.036.003-.074.001-.026.006-.053.002-.027.007-.055.01-.055.02-.113L8.767 17.52H1.049c-.792.002-1.298.862-.924 1.573l6.428 12.342.01.016a1 1 0 0 1-.085-.27"/>
  <path fill-rule="evenodd" clip-rule="evenodd" fill="#77B340" d="M21.99 31.038c-.041.584-.58.969-1.026.962H7.536c-.175 0-.356-.046-.356-.046-.557-.152-.82-.676-.681-1.296L8.766 17.52H14.5c.39 0 .747.216.931.565l6.428 12.342s.077.152.102.272.03.19.03.24z"/>
</svg>
...
## Uso correto das cores nos logos

| Logo | Texto/path | Símbolo |
|------|-----------|---------|
| Jusbrasil | `fill="currentColor"` (herda tema) | Amarelo `#FFCE00` + Azul `#378CC8` + Verde `#7AB441` fixos |
| Jus IA | `fill="currentColor"` no texto | Amarelo `#FC0` + Azul `#3D82DA` + Verde `#77B340` fixos |

As cores do símbolo são sempre fixas (não invertem no dark mode). O texto usa `currentColor`.

## Regra crítica: controle de cor via CSS, nunca no SVG

O `fill="currentColor"` herda o valor de `color` do elemento `<a>` que contém o SVG. **Nunca deixe o `<a>` sem `color` explícito**, pois o browser aplica a cor padrão de link (azul) e o logo ficará azul.

**Sempre** defina `color` no container do logo:

```css
/* Fundo claro → texto escuro */
.header-logo { color: var(--foreground); text-decoration: none; }

/* Fundo escuro → texto branco */
.footer-logo { color: white; text-decoration: none; }
```

Ou via inline quando não há classe:
```html
<!-- Fundo escuro -->
<a href="/" aria-label="Jusbrasil" style="color: white;">
  <svg ...>...</svg>
</a>
```

**Nunca** use `fill="white"`, `fill="black"`, `filter: brightness(0) invert(1)` ou qualquer outra técnica para mudar a cor do logo. Apenas `fill="currentColor"` + CSS `color` no container.
